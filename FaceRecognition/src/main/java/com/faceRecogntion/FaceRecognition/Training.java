...
public class Training {
	...
	public void training() {
		...
		File directory = new File(basePath + "/src/main/resources/photos");
		...
		for (File image : files) { // fill in the data to train classifiers
			Mat photo = opencv_imgcodecs.imread(image.getAbsolutePath(), opencv_imgcodecs.CV_LOAD_IMAGE_GRAYSCALE); // take
																													// the
																													// image
																													// by
																													// name
		...
		lbph.save(basePath + "/src/main/resources/classifierLBPH.yml");
		JOptionPane.showMessageDialog(null, "Training Faces Done!", "FACE RECOGNITION",
